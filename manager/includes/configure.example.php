<?php
  ...
  define('HTTP_COOKIE_PATH', '/advanture/manager');
  define('HTTPS_COOKIE_PATH', '/advanture/manager');
  define('HTTP_CATALOG_SERVER', 'http://localhost:8080');
  define('HTTPS_CATALOG_SERVER', 'http://localhost:8080');
  define('ENABLE_SSL_CATALOG', 'false');
  define('DIR_FS_DOCUMENT_ROOT', 'C:wamp\www\advanture/');
  define('DIR_WS_ADMIN', '/advanture/manager/');
  define('DIR_WS_HTTPS_ADMIN', '/advanture/manager/');
  define('DIR_FS_ADMIN', 'C:wamp\www\advanture\manager/');
  define('DIR_WS_CATALOG', '/advanture/');
  define('DIR_WS_HTTPS_CATALOG', '/advanture/');
  define('DIR_FS_CATALOG', 'C:wamp\www\advanture/');
