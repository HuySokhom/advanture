<?php
  ...
  define('HTTP_COOKIE_PATH', '/HR/jobAdmin');
  define('HTTPS_COOKIE_PATH', '/HR/jobAdmin');
  define('HTTP_CATALOG_SERVER', 'http://localhost');
  define('HTTPS_CATALOG_SERVER', 'http://localhost');
  define('ENABLE_SSL_CATALOG', 'false');
  define('DIR_FS_DOCUMENT_ROOT', '/var/www/HR/');
  define('DIR_WS_ADMIN', '/HR/jobAdmin/');
  define('DIR_WS_HTTPS_ADMIN', '/HR/jobAdmin/');
  define('DIR_FS_ADMIN', '/var/www/HR/jobAdmin/');
  define('DIR_WS_CATALOG', '/HR/');
